...
def holePosition(im):
    ...
    for i in range(-10,10):
        ...
        im.putpixel((holeRightEdgeLower,10+bottomHole+i ),(255,0,0))
...
for pic in positions:
    ...
    for i in range(-10,10):
        im.putpixel((int(im.size[0]/10)+i, topHole),(0,255,0))
        im.putpixel((int(im.size[0]/10)+i, bottomHole),(0,255,0))
        im.putpixel((holeRightEdge,10+topHole+i ),(0,255,0))
        im.putpixel((holeRightEdgeLower,10+bottomHole+i ),(0,255,0))
    im.save("cropped/"+pic)
